...
//  
//  Running on Windows 7 lb3314@EEWS104A-005 Service Pack 1 6.01.7601 i686
//  
...
//  
project new
solution file add {./color_summer.c} -type C++
...
directive set -DESIGN_HIERARCHY is_pixel_match
go compile
directive set /is_pixel_match/core/main -PIPELINE_INIT_INTERVAL 1
go architect
