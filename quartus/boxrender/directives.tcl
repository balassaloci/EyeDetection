...
//  
//  Running on Windows 7 lb3314@EEWS304-017 Service Pack 1 6.01.7601 i686
//  
...
//  
project new
solution file add {./block_render.c} -type C++
...
directive set -DESIGN_HIERARCHY render_blocks
go compile
directive set /render_blocks/core/FRAME -UNROLL yes
directive set /render_blocks/core/main -PIPELINE_INIT_INTERVAL 1
go architect
go extract
