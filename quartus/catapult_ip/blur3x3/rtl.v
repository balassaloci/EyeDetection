...
// 
//  Generated by:   lb3314@EEWS104A-015
//  Generated date: Fri Mar 13 16:18:58 2015
// ----------------------------------------------------------------------
...
module mean_vga_core (
  ...
  wire [3:0] FRAME_acc_52_sdt;
  wire [4:0] nl_FRAME_acc_52_sdt;
  ...
  assign nl_FRAME_acc_52_sdt = ({(~ (acc_imod_sva[4])) , 2'b11 , (~ (acc_imod_sva[4]))})
      + conv_s2u_2_4(~ (acc_imod_sva[6:5]));
  assign FRAME_acc_52_sdt = nl_FRAME_acc_52_sdt[3:0];
  assign nl_FRAME_acc_3_psp_1_sva = (conv_u2s_10_12(conv_u2s_20_11(conv_u2u_4_10(ACC2_5_acc_2_psp_sva[13:10])
      * 10'b101001)) + conv_s2s_7_11((conv_u2s_5_7({(ACC2_5_acc_2_psp_sva[9:6]) ,
      ...
      , 2'b1}) + conv_u2u_3_5(FRAME_acc_27_sdt[3:1])) , (FRAME_acc_27_sdt[0])}) +
  ...
  assign nl_FRAME_acc_4_psp_1_sva = (conv_u2s_10_12(conv_u2s_20_11(conv_u2u_4_10(ACC2_5_acc_3_psp_sva[13:10])
      * 10'b101001)) + conv_s2s_7_11((conv_u2s_5_7({(ACC2_5_acc_3_psp_sva[9:6]) ,
      ...
      , 2'b1}) + conv_u2u_3_5(FRAME_acc_43_sdt[3:1])) , (FRAME_acc_43_sdt[0])}) +
  ...
  assign nl_FRAME_acc_43_sdt = ({(~ (acc_imod_4_sva[4])) , 2'b11 , (~ (acc_imod_4_sva[4]))})
      + conv_s2u_2_4(~ (acc_imod_4_sva[6:5]));
  assign FRAME_acc_43_sdt = nl_FRAME_acc_43_sdt[3:0];
  ...
  assign nl_FRAME_acc_27_sdt = ({(~ (acc_imod_2_sva[4])) , 2'b11 , (~ (acc_imod_2_sva[4]))})
      + conv_s2u_2_4(~ (acc_imod_2_sva[6:5]));
  assign FRAME_acc_27_sdt = nl_FRAME_acc_27_sdt[3:0];
      ...
      if ( en ) begin
        ...
        reg_vout_rsc_mgc_out_stdreg_d_tmp <= ((conv_u2s_20_10(conv_u2u_4_10(ACC2_5_acc_1_psp_sva[13:10])
            * 10'b101001) + conv_s2s_7_10((conv_u2s_5_7({(ACC2_5_acc_1_psp_sva[9:6])
            ...
            , 2'b1}) + conv_u2u_3_5(FRAME_acc_52_sdt[3:1])) , (FRAME_acc_52_sdt[0])})
